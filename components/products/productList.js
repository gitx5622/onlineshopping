...
const ProductList = ({product_id, title, price, image, rating }) => {
    ...
    return (
           <Panel bordered style={{width:"250px", marginBottom:"10px"}}>
               <div data-test="product-image" style={{cursor: "pointer"}} onClick={() => router.push(`/products/${product_id}`)}>
               ...
               <Button data-test="add-to-cart" style={{width:"100%"}} color="orange" appearance="primary">Add to Cart</Button>
           </Panel>
    );
};
